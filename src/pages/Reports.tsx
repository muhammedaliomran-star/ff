...
function ReportsPage() {
  ...
  const series = useMemo(() => {
    const base = new Map<string, { month: string; label: string; sales: number; collected: number; expenses: number; profit: number }>(months.map((m) => [m, { month: m, label: monthLabel(m), sales: 0, collected: 0, expenses: 0, profit: 0 }]));
